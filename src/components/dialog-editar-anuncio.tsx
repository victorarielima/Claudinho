...
// ---------------------------------------------------------------------------
// CampoLink — link field with URL editor popup
// ---------------------------------------------------------------------------

function CampoLink({ valor, onChange }: { valor: string; onChange: (v: string) => void }) {
  ...
  return (
    <div>
      ...
      {editorAberto && (
        <EditorUtm
          url={valor}
          onSalvar={(novaUrl) => { onChange(novaUrl); setEditorAberto(false); }}
...
// ---------------------------------------------------------------------------
// EditorUtm — popup that shows URL components for easy editing
// ---------------------------------------------------------------------------

const UTM_KEYS = ["utm_source", "utm_medium", "utm_campaign", "utm_content", "utm_term"] as const;
const EXTRA_KEYS = ["openShop"] as const;
const KNOWN_KEYS = new Set<string>([...UTM_KEYS, ...EXTRA_KEYS]);
